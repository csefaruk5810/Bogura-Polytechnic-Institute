import 'package:bpi_teacher/CMT/cmtDetails.dart';
import 'package:bpi_teacher/CMT/cmtTeacher.dart';
import 'package:bpi_teacher/CT/ctTeacher.dart';
import 'package:bpi_teacher/ENT/ElectronicsDetails.dart';
...
import 'package:bpi_teacher/PT/PowerDetails.dart';
import 'package:bpi_teacher/PT/PowerTeacher.dart';
import 'package:bpi_teacher/RAC/RACDetails.dart';
...
class ElectronicsTeacher extends StatefulWidget {
  final ElectronicsDepartment detailOfElectronics;
  const ElectronicsTeacher({Key? key, required this.detailOfElectronics }) : super(key: key);
  @override
...
class _ElectronicsTeacherState extends State<ElectronicsTeacher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Computer Department Teacher List",
          style: TextStyle(
        ...
        itemBuilder: (context , index){
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ElectronicsDetails( electronicsDepartment: electronicsdata[index])),
              );
            },
            child: Padding(
              ...
              child: Center(
                  child: Container(
                    ...
                    width: size.width*.91,
                    decoration: BoxDecoration(
                      color: electronicsdata[index].BackColor,
                    ...
                    child: Container(
                      ...
                      width: size.width*.9,
                      decoration: BoxDecoration(
                          color: electronicsdata[index].FrontColor,
                          border: Border.all(
                            color: Colors.white,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(electronicsdata[index].UserImage),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: size.width*.58,
                              decoration: BoxDecoration(
                                color: electronicsdata[index].TextBackColor,
                                border: Border.all(
                                  width: 5,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text( electronicsdata[index].UserName,
                                    style: TextStyle(
                                  ...
                                  Padding(
                                    ...
                                    child: Text(electronicsdata[index].UserDesignation,
                                      style: TextStyle(
                                        fontFamily: 'Title',
