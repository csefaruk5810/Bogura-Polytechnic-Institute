...
import 'package:bpi_teacher/MT/MechanicalDetails.dart';
...
class MechanicalTeacher extends StatefulWidget {
  final MechanicalDepartment detailOfMechanical;
  const MechanicalTeacher({Key? key, required this.detailOfMechanical }) : super(key: key);

  @override
  _MechanicalTeacherState createState() => _MechanicalTeacherState();
}

class _MechanicalTeacherState extends State<MechanicalTeacher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Mechanical Department Teacher List",
          style: TextStyle(
        ...
        itemBuilder: (context , index){
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => MechanicalDetails(mechanicalDepartment: mechanicaldata[index],)),
              );
            },
            child: Padding(
              ...
              child: Center(
                  child: Container(
                    ...
                    width: size.width*.91,
                    decoration: BoxDecoration(
                      color: mechanicaldata[index].BackColor,
                    ...
                    child: Container(
                      ...
                      width: size.width*.9,
                      decoration: BoxDecoration(
                          color: mechanicaldata[index].FrontColor,
                          border: Border.all(
                            color: Colors.white,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(mechanicaldata[index].UserImage),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: size.width*.58,
                              decoration: BoxDecoration(
                                color: mechanicaldata[index].TextBackColor,
                                border: Border.all(
                                  width: 5,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text( mechanicaldata[index].UserName,
                                    style: TextStyle(
                                  ...
                                  Padding(
                                    ...
                                    child: Text(mechanicaldata[index].UserDesignation,
                                      style: TextStyle(
                                        fontFamily: 'Title',
