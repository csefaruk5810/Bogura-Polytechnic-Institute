...
import 'package:bpi_teacher/CT/civilDetails.dart';
...
class CivilTeacher extends StatefulWidget {
  final CivilDepartment detailOfCivil;
  const CivilTeacher({Key? key, required this.detailOfCivil }) : super(key: key);

  @override
  _CivilTeacherState createState() => _CivilTeacherState();
}

class _CivilTeacherState extends State<CivilTeacher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Civil Department Teacher List",
        style: TextStyle(
        ...
        itemBuilder: (context , index){
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => CivilDetails(civilDepartment: civildata[index],)),
              );
            },
            child: Padding(
              ...
              child: Center(
                  child: Container(
                    ...
                    width: size.width*.91,
                    decoration: BoxDecoration(
                      color: civildata[index].BackColor,
                    ...
                    child: Container(
                      ...
                      width: size.width*.9,
                      decoration: BoxDecoration(
                          color: civildata[index].FrontColor,
                          border: Border.all(
                            color: Colors.white,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(civildata[index].UserImage),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: size.width*.58,
                              decoration: BoxDecoration(
                                color: civildata[index].TextBackColor,
                                border: Border.all(
                                  width: 5,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(civildata[index].UserDesignation,
                                      style: TextStyle(
                                        fontFamily: 'Title',
