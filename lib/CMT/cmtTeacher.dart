...
class ComputerTeacher extends StatefulWidget {
  final ComputerDepartment detailOfComputer;
  const ComputerTeacher({Key? key, required this.detailOfComputer }) : super(key: key);
  @override
  _ComputerTeacherState createState() => _ComputerTeacherState();
}
        ...
        itemBuilder: (context , index){
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Computeretails(computerdepartment: computerdata[index], )),
              );
            },
            child: Padding(
              ...
              child: Center(
                  child: Container(
                    ...
                    width: size.width*.91,
                    decoration: BoxDecoration(
                      color: computerdata[index].BackColor,
                    ...
                    child: Container(
                      ...
                      width: size.width*.9,
                      decoration: BoxDecoration(
                          color: computerdata[index].FrontColor,
                          border: Border.all(
                            color: Colors.white,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(computerdata[index].UserImage),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: size.width*.58,
                              decoration: BoxDecoration(
                                color: computerdata[index].TextBackColor,
                                border: Border.all(
                                  width: 5,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text( computerdata[index].UserName,
                                    style: TextStyle(
                                  ...
                                  Padding(
                                    ...
                                    child: Text(computerdata[index].UserDesignation,
                                      style: TextStyle(
                                        fontFamily: 'Title',
