...
import 'package:bpi_teacher/MMST/MiningDetails.dart';
...
class MiningTeacher extends StatefulWidget {
  final MiningDepartment detailOfMining;
  const MiningTeacher({Key? key, required this.detailOfMining }) : super(key: key);

  @override
  _MiningTeacherState createState() => _MiningTeacherState();
}

class _MiningTeacherState extends State<MiningTeacher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Mining Department Teacher List",
          style: TextStyle(
        ...
        itemBuilder: (context , index){
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => MiningDetails(miningDepartment: miningdata[index],)),
              );
            },
            child: Padding(
              ...
              child: Center(
                  child: Container(
                    ...
                    width: size.width*.91,
                    decoration: BoxDecoration(
                      color: miningdata[index].BackColor,
                    ...
                    child: Container(
                      ...
                      width: size.width*.9,
                      decoration: BoxDecoration(
                          color: miningdata[index].FrontColor,
                          border: Border.all(
                            color: Colors.white,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(miningdata[index].UserImage),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: size.width*.58,
                              decoration: BoxDecoration(
                                color: miningdata[index].TextBackColor,
                                border: Border.all(
                                  width: 5,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text( miningdata[index].UserName,
                                    style: TextStyle(
                                  ...
                                  Padding(
                                    ...
                                    child: Text(miningdata[index].UserDesignation,
                                      style: TextStyle(
                                        fontFamily: 'Title',
