...
import 'package:bpi_teacher/THM/THMDetails.dart';
import 'package:bpi_teacher/detailsdata.dart';
import 'package:flutter/material.dart';
class TourismTeacher extends StatefulWidget {
  final TourismDepartment detailOfTourism;
  const TourismTeacher({Key? key, required this.detailOfTourism }) : super(key: key);

  @override
  _TourismTeacherState createState() => _TourismTeacherState();
}

class _TourismTeacherState extends State<TourismTeacher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Tourism & Hospitality Teacher List",
          style: TextStyle(
        ...
        itemBuilder: (context , index){
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => TourismDetails(tourismDepartment: tourismdata[index],)),
              );
            },
            child: Padding(
              ...
              child: Center(
                  child: Container(
                    ...
                    width: size.width*.91,
                    decoration: BoxDecoration(
                      color: tourismdata[index].BackColor,
                    ...
                    child: Container(
                      ...
                      width: size.width*.9,
                      decoration: BoxDecoration(
                          color: tourismdata[index].FrontColor,
                          border: Border.all(
                            color: Colors.white,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(tourismdata[index].UserImage),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: size.width*.58,
                              decoration: BoxDecoration(
                                color: tourismdata[index].TextBackColor,
                                border: Border.all(
                                  width: 5,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text( tourismdata[index].UserName,
                                    style: TextStyle(
                                  ...
                                  Padding(
                                    ...
                                    child: Text(tourismdata[index].UserDesignation,
                                      style: TextStyle(
                                        fontFamily: 'Title',
