...
import 'package:bpi_teacher/RS/RSDetails.dart';
import 'package:bpi_teacher/THM/THMTeacher.dart';
import 'package:bpi_teacher/detailsdata.dart';
import 'package:flutter/material.dart';
class RSTeacher extends StatefulWidget {
  final RSDepartment detailOfRS;
  const RSTeacher({Key? key, required this.detailOfRS }) : super(key: key);

  @override
  _RSTeacherState createState() => _RSTeacherState();
}

class _RSTeacherState extends State<RSTeacher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("RS Department Teacher List",
          style: TextStyle(
        ...
        itemBuilder: (context , index){
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => RSDetails(rsDepartment: rsdata[index],)),
              );
            },
            child: Padding(
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(rsdata[index].UserImage),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: size.width*.58,
                              decoration: BoxDecoration(
                                color: rsdata[index].TextBackColor,
                                border: Border.all(
                                  width: 5,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(rsdata[index].UserDesignation,
                                      style: TextStyle(
                                        fontFamily: 'Title',
