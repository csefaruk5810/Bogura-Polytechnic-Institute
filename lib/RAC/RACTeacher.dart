...
class RACTeacher extends StatefulWidget {
  final RACDepartment detailOfRAC;
  const RACTeacher({Key? key, required this.detailOfRAC }) : super(key: key);

  @override
  _RACTeacherState createState() => _RACTeacherState();
}

class _RACTeacherState extends State<RACTeacher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("RAC Department Teacher List",
          style: TextStyle(
        ...
        itemBuilder: (context , index){
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => RACDetails(racDepartment: racdata[index],)),
              );
            },
            child: Padding(
              ...
              child: Center(
                  child: Container(
                    ...
                    child: Container(
                      ...
                      width: size.width*.9,
                      decoration: BoxDecoration(
                          color: racdata[index].FrontColor,
                          border: Border.all(
                            color: Colors.white,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(racdata[index].UserImage),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: size.width*.58,
                              decoration: BoxDecoration(
                                color: racdata[index].TextBackColor,
                                border: Border.all(
                                  width: 5,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(racdata[index].UserDesignation,
                                      style: TextStyle(
                                        fontFamily: 'Title',
