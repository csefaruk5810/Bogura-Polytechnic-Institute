...
class PowerTeacher extends StatefulWidget {
  final PowerDepartment detailOfPower;
  const PowerTeacher({Key? key, required this.detailOfPower }) : super(key: key);

  @override
  _PowerTeacherState createState() => _PowerTeacherState();
}

class _PowerTeacherState extends State<PowerTeacher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Power Department Teacher List",
          style: TextStyle(
        ...
        itemBuilder: (context , index){
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => PowerDetails(powerDepartment: powerdata[index],)),
              );
            },
            child: Padding(
              ...
              child: Center(
                  child: Container(
                    ...
                    width: size.width*.91,
                    decoration: BoxDecoration(
                      color: powerdata[index].BackColor,
                    ...
                    child: Container(
                      ...
                      width: size.width*.9,
                      decoration: BoxDecoration(
                          color: powerdata[index].FrontColor,
                          border: Border.all(
                            color: Colors.white,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(powerdata[index].UserImage),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: size.width*.58,
                              decoration: BoxDecoration(
                                color: powerdata[index].TextBackColor,
                                border: Border.all(
                                  width: 5,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(powerdata[index].UserDesignation,
                                      style: TextStyle(
                                        fontFamily: 'Title',
